...
3. **Find the task file:** glob `tasks/**/TASK-NNN-*.md` recursively across all type subdirectories where NNN matches the numeric part of the given id. If not found, tell the user and stop.
...
5. **Log** to `wiki/log.md`:
   ...
   - Updated: tasks/<type>/TASK-NNN-<slug>.md → status: done
   ```
