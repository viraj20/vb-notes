...
3. **Find the task file:** glob `tasks/TASK-NNN-*.md` where NNN matches the numeric part of the given id. If not found, tell the user and stop.
...
5. **Log** to `wiki/log.md`:
   ...
   - Updated: tasks/TASK-NNN-<slug>.md → status: done
   ```
